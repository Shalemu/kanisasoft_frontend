      ...
      case 1:
        return (
          <>
            ...
            <Field label="Huduma Unayofanya *" name="churchService" onChange={handleChange} value={form.churchService} />
          </>
        );
      case 2:
        return (
          <>
            ...
            {(form.occupation === 'Nimeajiriwa' || form.occupation === 'Nimejiajiri') && (
              <>
                <Field label="Mahali pa Kazi (Si lazima)" name="workPlace" onChange={handleChange} value={form.workPlace} />
                <Field label="Mawasiliano ya Kazi (Si lazima)" name="workContact" onChange={handleChange} value={form.workContact} />
              </>
            )}
          </>
        );
