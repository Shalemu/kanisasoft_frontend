...
export default function WageniTab() {
 ...
 const handleAddVisitor = async () => {
  ...
  try {
    ...
    Swal.fire({
      title: 'Hongera!',
      text: 'Umefanikiwa kuongeza mgeni.',
      icon: 'success',
      confirmButtonText: 'Sawa',
      confirmButtonColor: '#f0ce32',
    });
    ...
    Swal.fire({
      title: 'Hitilafu',
      text: 'Hitilafu wakati wa kuhifadhi.',
      icon: 'error',
      confirmButtonText: 'Sawa',
      confirmButtonColor: '#f0ce32',
    });
 ...
 Swal.fire({
  title: failed ? 'Imeshindikana kidogo' : 'Ujumbe umetumwa!',
  html: `
    <b>${success}</b> ujumbe umetumwa kwa mafanikio.<br/>
    ${failed ? `<span style="color:red">${failed} imeshindikana.</span>` : ''}
  `,
  ...
  <div className="bg-white border border-gray-100 rounded-xl shadow-sm">
    ...
    <div className="border-b border-gray-100 px-4 md:px-6 py-4">
     ...
     {/* Buttons */}
<div className="flex flex-wrap items-center gap-3 bg-white/60 backdrop-blur-md p-3 rounded-xl shadow-sm border border-gray-100">

  {/* PRIMARY ACTION - ONGEZA FIRST */}
  <button
    onClick={() => setShowModal(true)}
    className="flex items-center gap-2 bg-blue-600 text-white px-4 py-2 rounded-lg text-xs font-semibold shadow-md hover:bg-blue-700 hover:scale-[1.02] transition"
  >
  ...
  <button
    ...
    className="flex items-center gap-2 bg-amber-500 text-white px-4 py-2 rounded-lg text-xs font-medium shadow-sm hover:bg-amber-600 hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed transition"
  >
  ...
  <button
    ...
    disabled={selectedIds.length === 0}
    className="flex items-center gap-2 bg-red-500 text-white px-4 py-2 rounded-lg text-xs font-medium shadow-sm hover:bg-red-600 hover:scale-[1.02] disabled:opacity-50 disabled:cursor-not-allowed transition"
  >
  ...
  <button
    ...
    className="flex items-center gap-2 bg-emerald-500 text-white px-4 py-2 rounded-lg text-xs font-medium shadow-sm hover:bg-emerald-600 hover:scale-[1.02] transition"
  >
  ...
  <button
    onClick={exportToPDF}
    className="flex items-center gap-2 bg-gray-900 text-white px-4 py-2 rounded-lg text-xs font-medium shadow-sm hover:bg-black hover:scale-[1.02] transition"
  >
    <FaFilePdf className="text-[12px]" />
    PDF
  </button>

  <label className="flex items-center gap-2 bg-violet-600 hover:bg-violet-700 text-white px-4 py-2 rounded-lg text-xs font-medium cursor-pointer shadow-sm hover:scale-[1.02] transition">
  ...
  <button
    ...
    className="flex items-center gap-2 bg-indigo-600 text-white px-4 py-2 rounded-lg text-xs font-medium shadow-sm hover:bg-indigo-700 hover:scale-[1.02] transition"
  >
    <FaFileExcel className="text-[12px]" />
    Template
  </button>
